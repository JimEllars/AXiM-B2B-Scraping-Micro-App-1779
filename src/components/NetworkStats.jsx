...
export default function NetworkStats() {
  ...
  return (
    <div className="mt-10 grid grid-cols-5 gap-3 w-full">
      ...
      <div className="bg-white/[0.02] border border-white/5 p-4 rounded-2xl flex flex-col items-center text-center group hover:border-axim-teal/30 transition-all">
        <SafeIcon icon={FiActivity} className="text-axim-teal mb-2 group-hover:scale-110 transition-transform" />
        <p className="text-[7px] font-black uppercase tracking-widest text-gray-500 mb-1">[CORE SYNC CONNECTIVITY]</p>
        <p className="font-mono text-[10px] text-axim-teal">[SECURE INTEGRITY VERIFIED // O-99 SYNC]</p>
      </div>
    </div>
  );
}